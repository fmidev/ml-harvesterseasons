bbox='-26.7188,38.2455,-26.0156,38.9473'
harbor='Horta'
FMISID='002956'
lat=38.5297
lon=-28.6286
...
fname = 'ece3-Horta.csv' # training input data file
mdl_name='mdl_'+pred+'_2000-2023_ece3_Horta.txt'
fscorepic='Fscore_'+pred+'-ece3-Horta.png'
xgbstudy='xgb-'+pred+'-ece3-Horta'
