...
rodict={'ro':'RO-M:ERA5L:5022:1:0:1:0'} # Runoff (m)
...
for point in llpdict.keys():
    ...
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ro5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ro15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ro60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ro100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
...
for point in llpdict.keys():
    ...
    dfpoint = df5[df5['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-sro5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-sro15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-sro60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-sro100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
...
for point in llpdict.keys():
    ...
    dfpoint = df5[df5['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ssro5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ssro15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ssro60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-ssro100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
...
for point in llpdict.keys():
    ...
    dfpoint = df5[df5['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evapp5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evapp15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evapp60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evapp100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)

### Evaporation rolling cumsums fot t-5, t-15, t-60 and t-100 days
evapdict={'evap':'EVAP-M:ERA5L:5022:1:0:1:0'} # Evaporation (m)
...
for point in llpdict.keys():
    ...
    dfpoint = df5[df5['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evap5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evap15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evap60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-evap100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)

### Precipitation rolling cumsums fot t-5, t-15, t-60 and t-100 days
tpdict={'tp':'RR-M:ERA5L:5022:1:0:1:0'} # Total precipitation (m)
...
for point in llpdict.keys():
    dfpoint = df[df['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-tp_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df5[df5['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-tp5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df15[df15['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-tp15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df60[df60['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-tp60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    dfpoint = df100[df100['pointID'] == point]
    dfpoint.to_csv(data_dir+'soilwater/era5l-fixed/era5l-tp100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
