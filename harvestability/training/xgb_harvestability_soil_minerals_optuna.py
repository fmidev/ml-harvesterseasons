...
def objective(trial):
    ...
    plt.savefig(plot_dir+'plot_importance_minerals.jpg')
    return accuracy
...
### Optuna trials
study = optuna.create_study(storage="sqlite:///MLexperiments.sqlite3",study_name="harvestability-soil-minerals-trial-2",direction="maximize")
