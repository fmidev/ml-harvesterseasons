...
soiltemp_file = "/home/ubuntu/data/ML/training-data/soiltemp/sd_temp_tif_features.csv"
soiltemp_ts_file = "/home/ubuntu/data/ML/training-data/snowdepth/sd__tif_features_ts.csv"

feature_cols = ["long","lat","DTM_height",
                "DTM_slope","DTM_aspect"]
...
def get_feature_values(long_lat):
    ...
    for i in  tqdm(range(0,len(long_lat)),desc ="Processing locations"):
        ...
        if results_for_height and results_for_slope and results_for_aspect :
