...
#    print(df)
    for point in llpdict.keys():
        ...
        dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-'+key+'_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
...
#    print(df)
    for point in llpdict.keys():
        dfpoint = df[df['pointID'] == point]
        dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-'+key+'-00_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
    #hour='12'
    #start='20060101T000000Z'
 #   start='20150101T000000Z'
...
#for point in llpdict.keys():
#    dfpoint = df[df['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-ro_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df5[df5['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-ro5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df15[df15['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-ro15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df60[df60['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-ro60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df100[df100['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-ro100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)

# THIS NOT NEEDED for SD?
...
#for point in llpdict.keys():
#    dfpoint = df[df['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-evap_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df5[df5['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-evap5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df15[df15['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-evap15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
 #   dfpoint = df60[df60['pointID'] == point]
 #   dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-evap60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
 #   dfpoint = df100[df100['pointID'] == point]
 #   dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-evap100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
...
#for point in llpdict.keys():
#    dfpoint = df[df['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-tp_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df5[df5['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-tp5d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df15[df15['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-tp15d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df60[df60['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-tp60d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
#    dfpoint = df100[df100['pointID'] == point]
#    dfpoint.to_csv(data_dir+'snowdepth/era5l/era5l-tp100d_'+y_start+'-'+y_end+'_'+str(point)+'.csv',index=False)
