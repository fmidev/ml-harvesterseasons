...
eu_data = eu_data[['site_lat','site_long']]
...
era5l00 = [
    ...
    {'skt':'SKT-K:AMSR:5070:1:0:0'}, #Soil temperature ASMR
...
AMSR0012utc =[{'st':'SKT-K:AMSR:5070:1:0:0'},
             ] # Soil temperature (K)              
...
time_series_df.to_csv("/home/ubuntu/data/ML/training-data/soiltemp/timeseries_features_latest_add.csv",index=False)
