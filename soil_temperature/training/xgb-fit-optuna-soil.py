...
cols_own=['utctime','slhf','sshf','ssrd','strd','str','ssr',
...
preds=['slhf','sshf','ssrd','strd','str','ssr',
          ...
          'sand_5_15cm_mean','silt_0_5cm_mean','silt_5_15cm_mean','clay_0_5cm_mean','clay_5_15cm_mean',
          'soc_0_5cm_mean','soc_5_15cm_mean','meanT_warmestQ_5_15cm','meanT_warmestQ_0_5cm',
          'mean_diurnal_0_5cm','clim_ts_value','dayOfYear'
]
var=['clim_ts_value']
...
### Optuna trials
study = optuna.create_study(storage="sqlite:///MLexperiments.sqlite3",study_name="xgb-soiltemp-1",direction="minimize",load_if_exists=True)
study.optimize(objective, n_trials=10, timeout=432000)
